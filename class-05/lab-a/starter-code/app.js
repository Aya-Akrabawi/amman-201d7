...
function sum(a, b) { //eslint-disable-line
    var plus = a + b
    var returnarray = [
        plus , 'The sum of ' + a + ' and ' + b + ' is ' + plus + '.'
    ]
    a = 4 
    b = 7
    return returnarray
...
function multiply(a, b) { //eslint-disable-
    var mult = a * b
    var returnedarray = [
        mult, 'The product of ' + a + ' and ' + b + ' is ' + mult + '.'
    ]
    a = 5
    b = 9
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    var product = a * b * c
    var returnarray = [
        sum, product , a + ' and ' + b + ' and ' + c + ' sum to ' + sum + '.' , 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + product + '.'
    ]
    a = 4
    b = 7 
    c = 5 
...
/////////////////////////////////////
/* Problem 4
Write a function called sumArray() that takes in an array of numbers as its single argument and thenz returns an array where the first
 element is the sum of the numbers in the array, and the second element is a string that EXACTLY follows this example and uses the values that were input into the function:
...
function sumArray(sumArr) { //eslint-disable-line
    ...
    sumArr = [ sum = testArray[0] + testArray[1] + testArray[2] ,
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    multArr = [ 
        multiply, "The numbers 2,3,4 have a product of " + multiply + "."
]
return multArr
}
...
first element is the product of those numbers, and the second element is a string that EXACTLY follows this example and concatenates
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    var product = testDynamicArray[0] * testDynamicArray[1] * testDynamicArray[2] * testDynamicArray[3] * testDynamicArray[4]
    var returnedarray = [ product, "The numbers 1,2,3,4,5 have a product of " + product + "."
] 
return returnedarray
}
